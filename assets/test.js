...
function buildDebugScoring(rawScore, cappedScore, checks, breakdown, extra = {}) {
  ...
  return {
    ...
    scoreSourceVersion: 'v1.11.11-real-render-source',
...
function buildReportCardHTML(result, formData, lang, modelIdInfo, operationalRisk) {
  ...
  // v1.11.11: Single source for top score — buildScoreBreakdown.finalScore
  ...
  return `<div id="result-card-inner" style="max-width:560px;margin:0 auto;padding:0 4px">
    ...
    <!-- v1.11.11: Score cap reason — only for truly fatal failures from buildScoreBreakdown -->
    <!-- v1.11.11: capEffective is the ONLY trigger for the failure banner -->
